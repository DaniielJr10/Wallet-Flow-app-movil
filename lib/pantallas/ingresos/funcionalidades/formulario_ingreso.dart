      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: const OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(12)), borderSide: BorderSide(color: UtilsIngresos.colorPrincipal, width: 2)),
            filled: true,
