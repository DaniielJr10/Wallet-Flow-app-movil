/// TARJETA DE RESUMEN
/// Muestra el total acumulado de ingresos mediante un StreamBuilder independiente.
...
class ResumenIngresos extends StatelessWidget {
  ...
  const ResumenIngresos({super.key, required this.ingresosServicio});
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: UtilsIngresos.colorPrincipal.withOpacity(0.3),
                blurRadius: 15,
