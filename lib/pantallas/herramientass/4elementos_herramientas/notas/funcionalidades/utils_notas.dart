...
class UtilsNotas {
  ...
  static const Color colorTextoTitulo = Color(0xFF059669);
  static const Color colorTextoGris = Color(0xFF6B7280);
  static const Color colorTextoOscuro = Color(0xFF111827);
  static const Color colorDelete = Color(0xFFE11D48);

  // Estilos de contenedores
  static const Color colorCardBg = Colors.white;
  static const Color colorInputBg = Color(0xFFF7FAF7);
  static const Color colorTagBg = Color(0xFFEEF9F2);
  static final Color colorSombra = Colors.green.withOpacity(0.04);
