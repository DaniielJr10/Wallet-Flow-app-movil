/// INPUT DE NOMBRE
/// Campo de texto configurado para nombres (mayúsculas iniciales).
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextFormField(
        ...
        validator: UtilsRegistro.validateName,
        decoration: InputDecoration(
          labelText: 'Nombre completo',
          hintText: 'Ingresa tu nombre completo',
          prefixIcon: const Icon(Icons.person_outline, color: UtilsRegistro.colorSecundario),
